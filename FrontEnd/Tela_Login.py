...
class TelaLogin(object):
    '''
    Este é um trecho de código Python que define a interface gráfica da tela de login do sistema. 
    A classe TelaLogin define os elementos gráficos da tela, como botões, rótulos e a janela principal. 
